    ...
    <div className="min-h-screen flex items-center justify-center bg-brand-background px-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 border border-slate-100">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 mt-2">Faça login para acessar o conteúdo</p>
        </div>
        ...
        <div className="mt-8 text-center text-sm text-slate-500 flex flex-col gap-2">
          <p>
            Não tem uma conta?{' '}
            <Link to="/membros/cadastro" className="text-brand-ui-element font-medium hover:text-brand-gold transition-colors">
              Cadastre-se
            </Link>
          </p>
